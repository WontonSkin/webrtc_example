...
#pragma comment(lib, "obj/video_coding_other.lib")
#pragma comment(lib, "obj/googletest.lib")
#pragma comment(lib, "obj/absl_other.lib")
#pragma comment(lib, "obj/webrtc_test.lib")
//#pragma comment(lib, "obj/system_wrappers_other.lib")
